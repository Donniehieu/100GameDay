...
namespace Pathfinding
{
	public abstract class NavGraph : IGraphInternals
	{
		...
		private string Pathfinding_002EIGraphInternals_002ESerializedEditorSettings
		{
			get
			{
				return null;
		...
		private void Pathfinding_002EIGraphInternals_002EOnDestroy()
		{
		}

		private void Pathfinding_002EIGraphInternals_002EDestroyAllNodes()
		{
		}

		private IEnumerable<Progress> Pathfinding_002EIGraphInternals_002EScanInternal()
		{
			return null;
		}

		private void Pathfinding_002EIGraphInternals_002ESerializeExtraInfo(GraphSerializationContext ctx)
		{
		}

		private void Pathfinding_002EIGraphInternals_002EDeserializeExtraInfo(GraphSerializationContext ctx)
		{
		}

		private void Pathfinding_002EIGraphInternals_002EPostDeserialization(GraphSerializationContext ctx)
		{
		}

		private void Pathfinding_002EIGraphInternals_002EDeserializeSettingsCompatibility(GraphSerializationContext ctx)
		{
		}
	}
}
