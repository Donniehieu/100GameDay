...
namespace Pathfinding.Util
{
	public class GraphTransform : IMovementPlane, ITransform
	{
		...
		private Vector2 Pathfinding_002EUtil_002EIMovementPlane_002EToPlane(Vector3 point)
		{
			return default(Vector2);
		}

		private Vector2 Pathfinding_002EUtil_002EIMovementPlane_002EToPlane(Vector3 point, out float elevation)
		{
			elevation = default(float);
			return default(Vector2);
		}

		private Vector3 Pathfinding_002EUtil_002EIMovementPlane_002EToWorld(Vector2 point, float elevation)
		{
			return default(Vector3);
		}
	}
