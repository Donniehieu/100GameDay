...
namespace UnityEngine.InputSystem
{
	internal class InputActionState : IInputStateChangeMonitor, ICloneable, IDisposable
	{
		...
		private void UnityEngine_002EInputSystem_002ELowLevel_002EIInputStateChangeMonitor_002ENotifyControlStateChanged(InputControl control, double time, InputEventPtr eventPtr, long mapControlAndBindingIndex)
		{
		}

		private void UnityEngine_002EInputSystem_002ELowLevel_002EIInputStateChangeMonitor_002ENotifyTimerExpired(InputControl control, double time, long mapControlAndBindingIndex, int interactionIndex)
		{
		}
		...
		internal void ChangePhaseOfInteraction(InputActionPhase newPhase, ref TriggerState trigger, InputActionPhase phaseAfterPerformed = InputActionPhase.Waiting, bool processNextInteractionOnCancel = true)
		{
		}
