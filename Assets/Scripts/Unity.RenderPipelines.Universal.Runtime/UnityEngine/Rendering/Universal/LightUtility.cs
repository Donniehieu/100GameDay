...
namespace UnityEngine.Rendering.Universal
{
	internal static class LightUtility
	{
		...
		private static void Tessellate(Tess tess, ElementType boundaryType, NativeArray<ushort> indices, NativeArray<LightMeshVertex> vertices, Color c, ref int VCount, ref int ICount)
		{
		}
		...
		private static List<IntPoint> DegeneratePivots(List<IntPoint> path, List<IntPoint> inPath)
		{
			return null;
		}
		...
		private static List<IntPoint> FixPivots(List<IntPoint> outPath, List<IntPoint> inPath)
		{
			return null;
		}
